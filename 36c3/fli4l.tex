...
% 36c3
\definecolor{36c3green}{RGB}{0,187,49}
\definecolor{36c3grey}{RGB}{208,208,206}
\definecolor{36c3orange}{RGB}{254,80,0}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{column}{0.3\textwidth}
            \begin{block}{Projekte}
                \begin{itemize}
                    \item \coloremph{36c3green}{\href{https://www.fli4l.de/}{fli4l}}
...
\begin{frame}
    \frametitle{Router}
    \framesubtitle{Backbone-Router, Border-Router, Edge-Router, …}
    \begin{figure}
        ...
        \begin{column}{0.65\textwidth}
            \begin{exampleblock}{Free/Libre and Open Source Software}
                \begin{itemize}
                    ...
                    \item \coloremph{white}{\href{https://www.ipfire.org/}{IPFire} (GNU/Linux)}
                    \only<1>{\item \coloremph{white}{\href{https://www.fli4l.de/}{fli4l} (GNU/Linux)}}
                    \only<2>{\item \coloremph{36c3green}{\href{https://www.fli4l.de/}{fli4l} (GNU/Linux)}}
                \end{itemize}
            \end{exampleblock}
        \end{column}
...
\strong{Date:} \coloremph{36c3green}{04/05/2000}\\
\strong{Author:} Frank Meyer
\tiny

Liebe Liste,

ich habe mir zu Hause aus einem alten \coloremph{36c3green}{486er} und einer einzelnen
\coloremph{36c3green}{Diskette(!)} einen i4l-Router zusammengebaut.
...
Hardwareausstattung\\
- AMD 486 DX4-100\\
- \coloremph{36c3green}{16MB Speicher}\\
- \coloremph{36c3green}{10 Mbit Netzwerkkarte} (NE2000-Clone)\\
- Teles 16.3 \coloremph{36c3green}{ISDN-Karte}\\
...
Der \coloremph{36c3green}{Kernel 2.0.35} ist zwar nicht mehr ganz aktuell. Ich habe aber
...
KERNEL_VERSION='4.19.91' # kernel version
...
\begin{frame}{Circuits}
    \begin{block}{Konzept}
        \begin{itemize}
            \item Begriff aus der Zeit von ISDN-Verbindungen
            \item Verbindung zwischen dem Router und einem \emph{anderen} Netzwerk
            \item zur Konfiguration von Routen
            \item Klassen, Abhängigkeiten, Bundles (Multilink-PPP, …)
            \item \texttt{circd} und \texttt{fli4lctrl}
            \item dynamische Nutzung in Konfiguration (bspw. Netze und Paketfilter)
        \end{itemize}
    \end{block}
    \begin{block}{Typen}
        \begin{itemize}
...
\begin{frame}{Roadmap}
    \begin{itemize}
        \item volle \coloremph{cyan}{IPv6}-Unterstützung
            (\href{https://web.nettworks.org/bugs/browse/FFL-2335}{FFL-2335},
            \href{https://web.nettworks.org/bugs/browse/FFL-1198}{FFL-1198})
            \small{
                \begin{itemize}
                    \item OpenVPN (\href{https://web.nettworks.org/bugs/browse/FFL-2028}{FFL-2028})
                    \item rrdtool (\href{https://web.nettworks.org/bugs/browse/FFL-2158}{FFL-2158})
                    \item DNS (\href{https://web.nettworks.org/bugs/browse/FFL-2384}{FFL-2384},
                        \href{https://web.nettworks.org/bugs/browse/FFL-2328}{FFL-2328})
                    \item DHCP (\href{https://web.nettworks.org/bugs/browse/FFL-469}{FFL-469})
                    \item Tor (\href{https://web.nettworks.org/bugs/browse/FFL-1503}{FFL-1503},
                        \href{https://web.nettworks.org/bugs/browse/FFL-889}{FFL-889})
                    \item dyndns (\href{https://web.nettworks.org/bugs/browse/FFL-2004}{FFL-2004},
                        \href{https://web.nettworks.org/bugs/browse/FFL-1463}{FFL-1463},
                        \href{https://web.nettworks.org/bugs/browse/FFL-1616}{FFL-1616},
                        \href{https://web.nettworks.org/bugs/browse/FFL-2531}{FFL-2531})
                    \item Paketfilter (\href{https://web.nettworks.org/bugs/browse/FFL-1066}{FFL-1066},
                        \href{https://web.nettworks.org/bugs/browse/FFL-1006}{FFL-1006})
                \end{itemize}
            }
        \item modernes \coloremph{cyan}{VPN} (wireguard anyone?)
        \item \coloremph{cyan}{UEFI}-Boot
        \item policy based routing (\href{https://web.nettworks.org/bugs/browse/FFL-546}{FFL-546})
        \item Erweiterung des \coloremph{cyan}{Circuit}-Systems \\
            (\coloremph{36c3orange}{\href{https://web.nettworks.org/bugs/browse/FFL-506}{FFL-506}},
            \href{https://web.nettworks.org/bugs/browse/FFL-1765}{FFL-1765},
            \href{https://web.nettworks.org/bugs/browse/FFL-2333}{FFL-2333},
            \href{https://web.nettworks.org/bugs/browse/FFL-1368}{FFL-1368},
            \href{https://web.nettworks.org/bugs/browse/FFL-1527}{FFL-1527})
        \item Unterstützung für mehr Single Board Computer
            (RPi*, BeagleBone*, ODROID*, BananaPi*, …
            → generisches \coloremph{cyan}{ARM}-Target)
        \item automatisierte \coloremph{cyan}{Tests}
    \end{itemize}
\end{frame}
