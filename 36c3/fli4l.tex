...
\begin{frame}{Roadmap}
    \begin{itemize}
        ...
        \item Unterstützung für mehr Single Board Computer
            (RPi*, BeagleBone*, ODROID*, BananaPi*, … → generisches ARM-Target)
